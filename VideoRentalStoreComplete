...
public class VideoRentalStoreComplete
{
	public static void main(String[] args)
	{
		...
		do{
			...
			System.out.println("3.Availability Checking");
			System.out.println("4.Retuen Video");
			...
			switch(choice)
			{
				...
				case 3:
					...
					String titleCheck = new Scanner(System.in).nextLine();
					objNewStore.checkOut(titleCheck);
					break;
				case 4:
					System.out.println("Enter the new video name");
					String titleReturn= new Scanner(System.in).nextLine();
					objNewStore.returnVideo(titleReturn);
					break;
			}
		}while(choice != 0);
	}
